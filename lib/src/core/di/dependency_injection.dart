...
Future<void> setupGetIt() async {
  ...
  // upload sound
  getIt.registerLazySingleton<UploadSoundRepo>(() => UploadSoundRepo(
        apiServices: getIt<ApiServices>(),
      ));

  getIt.registerLazySingleton<UploadSoundCubit>(() => UploadSoundCubit(
        soundsRepo: getIt<SoundsRepo>(),
        uploadSoundRepo: getIt<UploadSoundRepo>(),
      ));
}
